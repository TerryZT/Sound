...
export const wordBank: Word[] = [
    ...
    // 长元音
    { text: 'cake', segmentation: ['c', 'a', 'ke'], phonemeIds: ['k', 'long_a', 'long_a'], difficulty: 2 },
    { text: 'rain', segmentation: ['r', 'ai', 'n'], phonemeIds: ['r', 'long_a', 'n'], difficulty: 2 },
    { text: 'feet', segmentation: ['f', 'ee', 't'], phonemeIds: ['f', 'long_e', 't'], difficulty: 2 },
    { text: 'kite', segmentation: ['k', 'i', 'te'], phonemeIds: ['k', 'long_i', 'long_i'], difficulty: 2 },
    { text: 'boat', segmentation: ['b', 'oa', 't'], phonemeIds: ['b', 'long_o', 't'], difficulty: 2 },

    // 辅音与特殊拼写
    { text: 'phone', segmentation: ['ph', 'o', 'ne'], phonemeIds: ['f', 'long_o', 'long_o'], difficulty: 3 },
    { text: 'knee', segmentation: ['kn', 'ee'], phonemeIds: ['n', 'long_e'], difficulty: 3 },
    { text: 'duck', segmentation: ['d', 'u', 'ck'], phonemeIds: ['d', 'short_u', 'k'], difficulty: 2 },
    { text: 'shell', segmentation: ['sh', 'e', 'll'], phonemeIds: ['sh', 'short_e', 'l'], difficulty: 2 },
    { text: 'laugh', segmentation: ['l', 'au', 'gh'], phonemeIds: ['l', 'short_a', 'f'], difficulty: 4 },

    // 双元音
    { text: 'house', segmentation: ['h', 'ou', 'se'], phonemeIds: ['h', 'ou_ow', 'z'], difficulty: 3 },
    { text: 'coin', segmentation: ['c', 'oi', 'n'], phonemeIds: ['k', 'oi_oy', 'n'], difficulty: 3 },
    { text: 'book', segmentation: ['b', 'oo', 'k'], phonemeIds: ['b', 'short_oo', 'k'], difficulty: 2 },

    // R控制元音
    { text: 'star', segmentation: ['st', 'ar'], phonemeIds: ['s', 'ar'], difficulty: 2 },
    { text: 'bird', segmentation: ['b', 'ir', 'd'], phonemeIds: ['b', 'er', 'd'], difficulty: 3 },
    { text: 'torch', segmentation: ['t', 'or', 'ch'], phonemeIds: ['t', 'or', 'ch'], difficulty: 3 },
];
